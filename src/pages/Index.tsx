              ...
              <div className="animate-fade-in">
                ...
                <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm mb-6">
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                      <div>
                        <h3 className="text-2xl font-bold mb-2">Накопить на отпуск</h3>
                        <div className="flex items-center gap-4 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            <Icon name="Calendar" size={16} />
                            <span>01 января 2025 — 31 декабря 2025</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-pink-50">
                          ...
                          <div className="text-3xl font-bold text-purple-600">₽112,500</div>
                        </div>
                        <div className="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50">
                          ...
                          <div className="text-xs text-gray-500 mt-1">на текущий период</div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                        ...
                        <>
                          <div className="p-4 rounded-xl bg-gradient-to-r from-red-50 to-pink-50 hover:shadow-md transition-all duration-300">
                            <div className="flex justify-between items-start mb-2">
                              ...
                              <span className="text-lg font-bold text-red-600">-₽30,000</span>
                            </div>
                          </div>
                          <div className="p-4 rounded-xl bg-gradient-to-r from-red-50 to-pink-50 hover:shadow-md transition-all duration-300">
                            <div className="flex justify-between items-start mb-2">
                              ...
                              <span className="text-lg font-bold text-red-600">-₽10,000</span>
                            </div>
                          </div>
                        </>
                      )}
                      {activeTab === 'savings' && (
                        <>
                          <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 hover:shadow-md transition-all duration-300">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Ежемесячные сбережения</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                                  <span>01 января 2025</span>
                                </div>
                              </div>
                              <span className="text-lg font-bold text-purple-600">₽25,000</span>
                            </div>
                          </div>
                          <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 hover:shadow-md transition-all duration-300">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Доп. накопление</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                                  <span>15 января 2025</span>
                                </div>
                              </div>
                              <span className="text-lg font-bold text-purple-600">₽10,000</span>
                            </div>
                          </div>
                        </>
                      )}
                      ...
                      {activeTab === 'income' && (
                        <>
                          <div className="p-4 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 hover:shadow-md transition-all duration-300 border-l-4 border-green-500">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Зарплата декабрь</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                          ...
                          <div className="p-4 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 hover:shadow-md transition-all duration-300 border-l-4 border-green-500">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Фриланс проект</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                      ...
                      {activeTab === 'expenses' && (
                        <>
                          <div className="p-4 rounded-xl bg-gradient-to-r from-red-50 to-pink-50 hover:shadow-md transition-all duration-300 border-l-4 border-red-500">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Аренда декабрь</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                          ...
                          <div className="p-4 rounded-xl bg-gradient-to-r from-red-50 to-pink-50 hover:shadow-md transition-all duration-300 border-l-4 border-red-500">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Коммунальные услуги</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                                  <span>10 декабря 2024</span>
                                </div>
                              </div>
                              <span className="text-lg font-bold text-red-600">-₽5,200</span>
                            </div>
                          </div>
                        </>
                      )}
                      {activeTab === 'savings' && (
                        <>
                          <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 hover:shadow-md transition-all duration-300 border-l-4 border-purple-500">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Декабрь накопления</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                                  <span>01 декабря 2024</span>
                                </div>
                          ...
                          <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 hover:shadow-md transition-all duration-300 border-l-4 border-purple-500">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-semibold text-gray-800">Доп. взнос</h4>
                                <div className="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                  <Icon name="Calendar" size={12} />
                                  <span>15 декабря 2024</span>
                                </div>
                              </div>
                              <span className="text-lg font-bold text-purple-600">₽8,000</span>
                            </div>
                          </div>
                        </>
                      )}
